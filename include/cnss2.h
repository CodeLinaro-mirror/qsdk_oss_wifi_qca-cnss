...
static inline int cnss_enable_dynamic_mode_switch(struct device *dev, bool disable_ramdump)
{
	return -EINVAL;
}
...
#define cnss_wlan_unregister_driver qca_cnss_wlan_unregister_driver
#define cnss_device_crashed qca_cnss_device_crashed
#define cnss_pci_link_down qca_cnss_pci_link_down
#define cnss_pci_is_device_down qca_cnss_pci_is_device_down
#define cnss_schedule_recovery qca_cnss_schedule_recovery
#define cnss_self_recovery qca_cnss_self_recovery
#define cnss_force_fw_assert qca_cnss_force_fw_assert
#define cnss_force_collect_rddm qca_cnss_force_collect_rddm
#define cnss_get_virt_ramdump_mem qca_cnss_get_virt_ramdump_mem
#define cnss_get_fw_files_for_target qca_cnss_get_fw_files_for_target
#define cnss_get_platform_cap qca_cnss_get_platform_cap
#ifdef CONFIG_CNSS2_SMMU
#define cnss_smmu_get_domain qca_cnss_smmu_get_domain
#define cnss_smmu_map qca_cnss_smmu_map
#define cnss_smmu_unmap qca_cnss_smmu_unmap
#endif
#define cnss_bus_get_soc_info qca_cnss_bus_get_soc_info
#define cnss_request_bus_bandwidth qca_cnss_request_bus_bandwidth
#define cnss_power_on_device qca_cnss_power_on_device
#define cnss_power_off_device qca_cnss_power_off_device
#define cnss_power_up qca_cnss_power_up
#define cnss_power_down qca_cnss_power_down
#define cnss_idle_restart qca_cnss_idle_restart
#define cnss_idle_shutdown qca_cnss_idle_shutdown
#ifndef CONFIG_CNSS2_KERNEL_5_15
#define cnss_request_pm_qos qca_cnss_request_pm_qos
#define cnss_remove_pm_qos qca_cnss_remove_pm_qos
#endif
#define cnss_lock_pm_sem qca_cnss_lock_pm_sem
#define cnss_release_pm_sem qca_cnss_release_pm_sem
#define cnss_wlan_pm_control qca_cnss_wlan_pm_control
#define cnss_auto_suspend qca_cnss_auto_suspend
#define cnss_auto_resume qca_cnss_auto_resume
#define cnss_pci_is_drv_connected qca_cnss_pci_is_drv_connected
#define cnss_pci_force_wake_request qca_cnss_pci_force_wake_request
#define cnss_pci_is_device_awake qca_cnss_pci_is_device_awake
#define cnss_pci_force_wake_release qca_cnss_pci_force_wake_release
#define cnss_bus_get_user_msi_assignment qca_cnss_bus_get_user_msi_assignment
#define cnss_bus_get_msi_irq qca_cnss_bus_get_msi_irq
#define cnss_get_pci_slot qca_cnss_get_pci_slot
#define cnss_bus_get_msi_address qca_cnss_bus_get_msi_address
#define cnss_wlan_enable qca_cnss_wlan_enable
#define cnss_wlan_disable qca_cnss_wlan_disable
#define cnss_get_boot_timeout qca_cnss_get_boot_timeout
#define cnss_wait_for_fw_ready qca_cnss_wait_for_fw_ready
#define cnss_check_is_shmem_capable qca_cnss_check_is_shmem_capable
#define cnss_set_ramdump_enabled qca_cnss_set_ramdump_enabled
#define cnss_set_recovery_enabled qca_cnss_set_recovery_enabled
#define cnss_subsystem_get qca_cnss_subsystem_get
#define cnss_subsystem_put qca_cnss_subsystem_put
#define cnss_pcie_rescan qca_cnss_pcie_rescan
#define cnss_pcie_remove_bus qca_cnss_pcie_remove_bus
#define cnss_get_pci_dev_by_device_id qca_cnss_get_pci_dev_by_device_id
#define cnss_get_pci_dev_from_plat_dev qca_cnss_get_pci_dev_from_plat_dev
#define cnss_get_pci_dev_id_from_plat_dev qca_cnss_get_pci_dev_id_from_plat_dev
#define cnss_dump_all_ce_reg qca_cnss_dump_all_ce_reg
#define cnss_get_qmi_timeout qca_cnss_get_qmi_timeout
#define cnss_athdiag_read qca_cnss_athdiag_read
#define cnss_athdiag_write qca_cnss_athdiag_write
#define cnss_is_dev_initialized qca_cnss_is_dev_initialized
#define cnss_bus_get_q6_time qca_cnss_bus_get_q6_time
#define cnss_dump_qmi_history qca_cnss_dump_qmi_history
#define cnss_get_ramdump_device_name qca_cnss_get_ramdump_device_name
#define cnss_get_driver_mode qca_cnss_get_driver_mode
#define cnss_set_driver_mode qca_cnss_set_driver_mode
#define cnss_get_global_mlo_support qca_cnss_get_global_mlo_support
#define cnss_send_buffer_to_afcmem qca_cnss_send_buffer_to_afcmem
#define cnss_reset_afcmem qca_cnss_reset_afcmem
#define cnss_get_mlo_chip_id qca_cnss_get_mlo_chip_id
#define cnss_get_mlo_capable qca_cnss_get_mlo_capable
#define cnss_is_mlo_default_cfg_enabled qca_cnss_is_mlo_default_cfg_enabled
#define cnss_get_mlo_global_config_region_info qca_cnss_get_mlo_global_config_region_info
#define cnss_get_num_mlo_links qca_cnss_get_num_mlo_links
#define cnss_get_mlo_chip_info qca_cnss_get_mlo_chip_info
#define cnss_get_num_mlo_capable_devices qca_cnss_get_num_mlo_capable_devices
#define cnss_get_max_mlo_chips qca_cnss_get_max_mlo_chips
#define cnss_get_dev_link_ids qca_cnss_get_dev_link_ids
#define cnss_bus_reg_read qca_cnss_bus_reg_read
#define cnss_bus_reg_write qca_cnss_bus_reg_write
#define cnss_set_bar_addr qca_cnss_set_bar_addr
#define cnss_set_mlo_config qca_cnss_set_mlo_config
#define cnss_set_mlo_group_config qca_cnss_set_mlo_group_config
#define cnss_set_default_mlo_config qca_cnss_set_default_mlo_config
#define cnss_reset_mlo_config qca_cnss_reset_mlo_config
#define cnss_print_mlo_config qca_cnss_print_mlo_config
#define cnss_set_led_gpio qca_cnss_set_led_gpio
#define cnss_get_enable_intx qca_cnss_get_enable_intx
#define cnss_get_plat_dev_by_bus_dev qca_cnss_get_plat_dev_by_bus_dev
#define cnss_get_num_mlo_groups qca_cnss_get_num_mlo_groups
